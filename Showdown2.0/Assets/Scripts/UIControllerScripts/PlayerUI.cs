...
public class PlayerUI : MonoBehaviour
{
    ...
    public IEnumerator ChangePhase()
    {
        ...
        {
            competencesCooldowns[0].transform.parent.parent.parent.localScale = new Vector3(1f - i, 1f - i, 1f - i);
        ...
        competencesCooldowns[0].transform.parent.parent.parent.localScale = new Vector3(1f, 1f, 1f);
    ...
    void Update()
    {
        ...
        for(int i = 0; i < competencesCooldowns.Length; i++)
        {
            if(playerManager.buildNumber == 1)
                competencesTexts[i].text = playerManager.competenceSlots[i].competenceData1.name;
            else if (playerManager.buildNumber == 2)
                competencesTexts[i].text = playerManager.competenceSlots[i].competenceData2.name;
